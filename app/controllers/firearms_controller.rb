class FirearmsController < ApplicationController
  ...
  private
    ...
    def firearm_params
      params.require(:firearm).permit(:name, :typearm, :atstus, :country, :year, :caliber, :action_type, :trigger_type, :feeding_mech, :barrel_l, :over_l, :over_l_f, :em_w, :l_w, :am_cap, :fr_mat, :stock_type, :img_main)
    end
end
