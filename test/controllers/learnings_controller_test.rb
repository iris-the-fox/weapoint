...
class LearningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create learning" do
    assert_difference('Learning.count') do
      post learnings_url, params: { learning: { name: @learning.name, note: @learning.note, range: @learning.range, tag: @learning.tag } }
    end
  ...
  test "should update learning" do
    patch learning_url(@learning), params: { learning: { name: @learning.name, note: @learning.note, range: @learning.range, tag: @learning.tag } }
